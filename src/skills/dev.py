    ...
    def intents(self, ctx):
        return [
            ...
            IntentSpec(name="dev.stackoverflow", priority=670,
                       ...
                       handler=_stackoverflow, examples=("stackoverflow",)),
        ]
