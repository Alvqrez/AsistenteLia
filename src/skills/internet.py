    ...
    def intents(self, ctx):
        return [
            ...
            IntentSpec(name="internet.maps", priority=268,
                       ...
                       handler=_maps, examples=("maps madrid", "abre maps")),
            ...
            IntentSpec(name="internet.conexion", priority=460,
                       ...
                       handler=_conexion, examples=("hay internet",)),
